export default function ListElement({date, topic, author, comments}) {
    return (
        <div className="col-span-12 grid grid-cols-12 gap-4 bg-slate-800 px-4 py-2 rounded-3xl hover:bg-slate-700 border border-slate-600 hover:border-slate-500">
